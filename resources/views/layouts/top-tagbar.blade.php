                    ...
                    <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                        <button type="button" class="btn btn-icon btn-topbar text-reset rounded-circle fs-14 fw-medium"
                            ...
                            @switch(Session::get('lang'))
                                @case('ru')
                                    <img src="{{ URL::asset('../../images/flags/russia.svg') }}" class="rounded-circle me-2"
                                        alt="Header Language" height="16">
                                    <span id="lang-name">русский</span>
                                @break

                                @case('it')
                                    <img src="{{ URL::asset('../../images/flags/italy.svg') }}" class="rounded-circle me-2"
                                        alt="Header Language" height="16">
                                    <span id="lang-name">Italiana</span>
                                @break

                                @case('sp')
                                    <img src="{{ URL::asset('../../images/flags/spain.svg') }}" class="rounded-circle me-2"
                                        alt="Header Language" height="16">
                                    <span id="lang-name">Española</span>
                                @break

                                @case('ch')
                                    <img src="{{ URL::asset('../../images/flags/china.svg') }}" class="rounded-circle me-2"
                                        alt="Header Language" height="16">
                                    <span id="lang-name">中国人</span>
                                @break

                                @case('fr')
                                    <img src="{{ URL::asset('../../images/flags/french.svg') }}" class="rounded-circle me-2"
                                        alt="Header Language" height="16">
                                    <span id="lang-name">français</span>
                                @break

                                @case('gr')
                                    <img src="{{ URL::asset('../../images/flags/germany.svg') }}" class="rounded-circle me-2"
                                        alt="Header Language" height="16">
                                    <span id="lang-name">Deutsche</span>
                                @break

                                @case('sa')
                                    <img src="{{ URL::asset('../../images/flags/sa.svg') }}" class="rounded-circle me-2"
                                        alt="Header Language" height="16">
                                    <span id="lang-name">عربى</span>
                                @break

                                @default
                                    <img src="{{ URL::asset('../../images/flags/us.svg') }}" class="rounded-circle me-2"
                                        alt="Header Language" height="16">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a href="{{ url('index/sp') }}" class="dropdown-item notify-item language" data-lang="sp"
                                title="Spanish">
                                <img src="{{ URL::asset('../../images/flags/spain.svg') }}" alt="user-image"
                                    class="me-2 rounded-circle" height="18">
                            ...
                            <a href="{{ url('index/gr') }}" class="dropdown-item notify-item language" data-lang="gr"
                                title="German">
                                <img src="{{ URL::asset('../../images/flags/germany.svg') }}" alt="user-image"
                            ...
                            <a href="{{ url('index/it') }}" class="dropdown-item notify-item language" data-lang="it"
                                title="Italian">
                                <img src="{{ URL::asset('../../images/flags/italy.svg') }}" alt="user-image"
                                    class="me-2 rounded-circle" height="18">
                            ...
                            <a href="{{ url('index/ru') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('../../images/flags/russia.svg') }}" alt="user-image"
                                    class="me-2 rounded-circle" height="18">
                            ...
                            <a href="{{ url('index/ch') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('../../images/flags/china.svg') }}" alt="user-image"
                                    class="me-2 rounded-circle" height="18">
                            ...
                            <a href="{{ url('index/fr') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('../../images/flags/french.svg') }}" alt="user-image"
                                    class="me-2 rounded-circle" height="18">
                            ...
                            <a href="{{ url('index/sa') }}" class="dropdown-item notify-item language"
                                ...
                                <img src="{{ URL::asset('../../images/flags/sa.svg') }}" alt="user-image"
                                    class="me-2 rounded-circle" height="18">
