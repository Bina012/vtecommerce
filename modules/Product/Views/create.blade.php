...
@section('content')
    ...
    <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data" id="createproduct-form" autocomplete="off" class="needs-validation" novalidate>
    {!!csrf_field() !!} 
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="id" id="product-id-input" class="form-control" value="">
                            <input type="text" name="title" class="form-control" id="product-title-input" value=""
                        ...
                        <div>
                            ...
                            <div>
                                <select name="category_id" class="form-select" id="choices-category-input" name="choices-category-input">
                        ...
                        <div class="row ">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="manufacture_name" class="form-control" id="manufacturer-name-input"
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="manufacture_brand" class="form-control" id="manufacturer-brand-input"
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="stocks" class="form-control" id="stocks-input" placeholder="Stocks"
                                        required>
                            ...
                            <div class="col-lg-6">
                                <div class="mt-3 mt-lg-0">
                                    ...
                                    <ul class="clothe-size list-unstyled hstack gap-2 mb-0 flex-wrap" id="size-filter">
                                        <li>
                                            <input type="checkbox" name="sizes[]" value="xs" id="sizeXs">
                                            <label
                                        ...
                                        <li>
                                            <input type="checkbox" name="sizes[]" value="2xl" id="size2xl">
                                            <label
                                                class="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                                                for="size2xl">2XL</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" name="sizes[]" value="3xl" id="size3xl">
                                            <label
                                                class="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                                                for="size3xl">3XL</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" name="sizes[]" value="40" id="size40">
                                            <label
                                                class="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                                                for="size40">40</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" name="sizes[]" value="41" id="size41">
                                            <label
                                                class="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                                                for="size41">41</label>
                                        </li>
                                        <li>
                                            <input type="checkbox" name="sizes[]" value="42" id="size42">
                                            <label
                                                class="avatar-xs btn btn-soft-primary p-0 d-flex align-items-center justify-content-center rounded-circle"
                                                for="size42">42</label>
                                        </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <select name="visibility" class="form-select" id="choices-publish-visibility-input" data-choices
                                data-choices-search-false>
